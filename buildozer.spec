...
# (str) Package name
package.name = agrosansar

# (str) Package domain (needed for android/ios packaging)
package.domain = com.agrosansar

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,jpeg,kv,atlas,ttf,TTF,json,JSON,csv,CSV,tflite
...
source.exclude_dirs = tests, bin, venv, .venv, .venv_mac, model_evaluation_test, disease/dataset
...
requirements = python3,kivy==2.3.1,kivymd==1.2.0,numpy==1.26.4,pillow,requests,rapidfuzz,plyer,pyjnius,urllib3,certifi
